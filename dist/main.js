...
.edit:hover {
  transform: scale(1.1);
  filter: invert(0.4) sepia(1) saturate(19) hue-rotate(316.8deg) brightness(1.19);
  box-shadow: rgba(255, 166, 0, 1) 0px 2px 10px;
}
...
.task-name-description {
  display: grid;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA,UAAU;AACV;EACE,aAAa;EACb,eAAe;EACf,UAAU;EACV,OAAO;EACP,MAAM;EACN,WAAW;EACX,YAAY;EACZ,cAAc;EACd,oCAAoC;AACtC;;AAEA;EACE,yBAAyB;EACzB,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;;EAEE,YAAY;EACZ,qBAAqB;EACrB,eAAe;AACjB;;AAEA,iBAAiB;AACjB;EACE,aAAa;EACb,4DAA4D;EAC5D,SAAS;AACX;;AAEA;EACE,yBAAyB;AAC3B;;AAEA,aAAa;AACb;EACE,yBAAyB;AAC3B;;AAEA;;EAEE,gBAAgB;EAChB,iBAAiB;AACnB;;AAEA;EACE,eAAe;EACf,YAAY;EACZ,mBAAmB;EACnB,oCAAoC;AACtC;;AAEA;EACE,aAAa;EACb,8BAA8B;AAChC;;AAEA;EACE,2BAA2B;AAC7B;;AAEA;EACE,WAAW;;AAEb;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,eAAe;EACf,aAAa;EACb,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,mBAAmB;EACnB,iCAAiC;AACnC;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,uBAAuB;EACvB,SAAS;EACT,8BAA8B;EAC9B,aAAa;;EAEb,uCAAuC;EACvC,QAAQ;AACV;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,YAAY;AACd;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,qBAAqB;EACrB,+EAA+E;EAC/E,6CAA6C;AAC/C;;AAEA,YAAY;AACZ;EACE,aAAa;EACb,QAAQ;AACV;;AAEA;EACE,aAAa;AACf","sourcesContent":["/* Modal */\n.modal {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modal-content {\n  background-color: #fefefe;\n  margin: 15% auto;\n  padding: 20px;\n  border: 1px solid #888;\n  width: 80%;\n}\n\n.close {\n  color: #aaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n/* Main content */\n.main-container {\n  display: grid;\n  grid-template-columns: minmax(auto, 250px) minmax(auto, 1fr);\n  gap: 20px;\n}\n\n.content {\n  background-color: #e0e0e0;\n}\n\n/* side bar */\n.side-bar {\n  background-color: #f0f0f0;\n}\n\n.project-list-default,\n.project-list-created {\n  line-height: 1.5;\n  font-size: 1.1rem;\n}\n\n.project-name {\n  cursor: pointer;\n  flex-grow: 2;\n  /* display: flex; */\n  /* justify-content: space-between; */\n}\n\n.project-div {\n  display: flex;\n  justify-content: space-between;\n}\n\n.project-div:hover {\n  background-color: lightcyan;\n}\n\n.project-name:hover {\n  opacity: .7;\n\n}\n\n.active-list {\n  font-weight: 700;\n}\n\n.new-project-form {\n  display: flex;\n}\n\n.btn {\n  cursor: pointer;\n  background: 0;\n  border: 0;\n  padding: 0;\n}\n\n.btn.create {\n  font-size: 1.5rem;\n  font-weight: 900;\n  margin-right: .25em;\n  transition: opacity 150ms ease-in;\n}\n\n.btn.create:hover {\n  opacity: .7;\n}\n\n.new {\n  background: transparent;\n  border: 0;\n  border-bottom: 1px solid black;\n  outline: none;\n\n  transition: border-bottom 120ms ease-in;\n  order: 2;\n}\n\n.new:focus {\n  border-bottom-width: 3px;\n}\n\n.new:focus::placeholder {\n  opacity: .2;\n}\n\n.icons {\n  display: flex;\n  align-items: center;\n}\n\n.trash {\n  width: 24px;\n  height: 24px;\n}\n\n.edit {\n  cursor: pointer;\n}\n\n.edit:hover {\n  transform: scale(1.1);\n  filter: invert(0.4) sepia(1) saturate(19) hue-rotate(316.8deg) brightness(1.19);\n  box-shadow: rgba(255, 166, 0, 1) 0px 2px 10px;\n}\n\n/* Task UI */\n.task-element {\n  display: flex;\n  gap: 8px;\n}\n\n.task-name-description {\n  display: grid;\n}"],"sourceRoot":""}]);
// Exports
...
function ScreenController() {
  ...
  const upcoming = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]('This Week');
  const all = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]('All');
  const stuff = new _project__WEBPACK_IMPORTED_MODULE_1__["default"]('Stuff');
  const task = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]('Bread', 'sandwiches', (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.parseISO)('2024-04-01'), 'MM-dd-yyyy'), 'High', 'Inbox');
  const task2 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]('Milk', 'basics', (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.parseISO)('2024-04-01'), 'MM-dd-yyyy'), 'High', 'Index');
  const task3 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]('Fix sink', 'leaky faucet', (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.parseISO)('2024-04-01'), 'MM-dd-yyyy'), 'medium', 'Inbox');
  inbox.addTask(task);
  inbox.addTask(task2)
  inbox.addTask(task3);
  ...
  const renderUserCreatedProjects = () => {
    ...
    todo.projects.forEach((project) => {
      if (project.getTitle() !== 'Inbox' &&
        ...
        edit.src = _Images_edit_svg__WEBPACK_IMPORTED_MODULE_4__;
        const trash = new Image();
        trash.src = _Images_trash_svg__WEBPACK_IMPORTED_MODULE_3__;
  ...
  function renderSelectedProject(project) {
    ...
    project.tasks.forEach(task => {
      ...
      <input type="checkbox" dataset-taskId = "${task.id}" id="${task.task}">
  ...
  const createNewTask = (e) => {
    e.preventDefault();
    const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_6__.parseISO)(dueDateInput.value), 'MM-dd-yyyy')
    const createTask = new _task__WEBPACK_IMPORTED_MODULE_0__["default"](taskNameInput.value, descriptionInput.value, newDate, priorityInput.value, projectInput.value)
  ...
  function createNewProject(e) {
    e.preventDefault();
    const projectTitle = new _project__WEBPACK_IMPORTED_MODULE_1__["default"](projectFormTitle.value);
  ...
  sideBar.addEventListener('click', e => {
    if (e.target.className === 'project-name') {
      ...
      projectModal();
      // currentProject.setTitle(projectEditTitle.value);
...
(0,_dom__WEBPACK_IMPORTED_MODULE_2__.ScreenController)();
...
module.exports = __webpack_require__.p + "b1682dc987a54afaddc8.svg";
...
module.exports = __webpack_require__.p + "3d2988b311fcd67dbb2d.svg";
