...
.task-element {
  display: flex;
  gap: 8px;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,aAAa;EACb,eAAe;EACf,UAAU;EACV,OAAO;EACP,MAAM;EACN,WAAW;EACX,YAAY;EACZ,cAAc;EACd,oCAAoC;AACtC;;AAEA;EACE,yBAAyB;EACzB,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,WAAW;EACX,YAAY;EACZ,eAAe;EACf,iBAAiB;AACnB;;AAEA;;EAEE,YAAY;EACZ,qBAAqB;EACrB,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,4DAA4D;;EAE5D,SAAS;;AAEX;;AAEA;EACE,yBAAyB;;AAE3B;;AAEA;EACE,yBAAyB;;AAE3B;;AAEA;;EAEE,gBAAgB;EAChB,iBAAiB;AACnB;;;AAGA;EACE,eAAe;AACjB;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,aAAa;AACf;;AAEA;EACE,eAAe;EACf,aAAa;EACb,SAAS;EACT,UAAU;AACZ;;AAEA;EACE,iBAAiB;EACjB,gBAAgB;EAChB,mBAAmB;EACnB,iCAAiC;AACnC;;AAEA;EACE,WAAW;AACb;;AAEA;EACE,uBAAuB;EACvB,SAAS;EACT,8BAA8B;EAC9B,aAAa;;EAEb,uCAAuC;EACvC,QAAQ;AACV;;AAEA;EACE,wBAAwB;AAC1B;;AAEA;EACE,WAAW;AACb;;AAEA,YAAY;AACZ;EACE,aAAa;EACb,QAAQ;AACV","sourcesContent":[".modal {\n  display: none;\n  position: fixed;\n  z-index: 1;\n  left: 0;\n  top: 0;\n  width: 100%;\n  height: 100%;\n  overflow: auto;\n  background-color: rgba(0, 0, 0, 0.4);\n}\n\n.modal-content {\n  background-color: #fefefe;\n  margin: 15% auto;\n  padding: 20px;\n  border: 1px solid #888;\n  width: 80%;\n}\n\n.close {\n  color: #aaa;\n  float: right;\n  font-size: 28px;\n  font-weight: bold;\n}\n\n.close:hover,\n.close:focus {\n  color: black;\n  text-decoration: none;\n  cursor: pointer;\n}\n\n.main-container {\n  display: grid;\n  grid-template-columns: minmax(auto, 250px) minmax(auto, 1fr);\n\n  gap: 20px;\n\n}\n\n.side-bar {\n  background-color: #f0f0f0;\n\n}\n\n.content {\n  background-color: #e0e0e0;\n\n}\n\n.project-list-default,\n.project-list-created {\n  line-height: 1.5;\n  font-size: 1.1rem;\n}\n\n\n.project-name {\n  cursor: pointer;\n}\n\n.project-name:hover {\n  opacity: .7;\n}\n\n.active-list {\n  font-weight: 700;\n}\n\n.new-project-form {\n  display: flex;\n}\n\n.btn {\n  cursor: pointer;\n  background: 0;\n  border: 0;\n  padding: 0;\n}\n\n.btn.create {\n  font-size: 1.5rem;\n  font-weight: 900;\n  margin-right: .25em;\n  transition: opacity 150ms ease-in;\n}\n\n.btn.create:hover {\n  opacity: .7;\n}\n\n.new {\n  background: transparent;\n  border: 0;\n  border-bottom: 1px solid black;\n  outline: none;\n\n  transition: border-bottom 120ms ease-in;\n  order: 2;\n}\n\n.new:focus {\n  border-bottom-width: 3px;\n}\n\n.new:focus::placeholder {\n  opacity: .2;\n}\n\n/* Task UI */\n.task-element {\n  display: flex;\n  gap: 8px;\n}"],"sourceRoot":""}]);
// Exports
...
function ScreenController() {
  ...
  const task = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]('Bread', 'sandwiches', (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.parseISO)('2024-04-01'), 'MM-dd-yyyy'), 'High', 'Inbox');
  const task2 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]('Milk', 'basics', (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.parseISO)('2024-04-01'), 'MM-dd-yyyy'), 'High', 'Index');
  const task3 = new _task__WEBPACK_IMPORTED_MODULE_0__["default"]('Fix sink', 'leaky faucet', (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.parseISO)('2024-04-01'), 'MM-dd-yyyy'), 'medium', 'Inbox');
  inbox.addTask(task);
  inbox.addTask(task2)
  inbox.addTask(task3);
  ...
  const createNewTask = (e) => {
    e.preventDefault();
    const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)((0,date_fns__WEBPACK_IMPORTED_MODULE_4__.parseISO)(dueDateInput.value), 'MM-dd-yyyy')
...
//   projectInput.value = task.listName;
//   openModal();
...
//     if (projectInput.value !== task.listName) {
//       const newProject = projects.find(project => project.getTitle() === projectInput.value);
//       console.log(newProject.getProjectList())

//       const indexOfOld = projects.findIndex(project => project.getTitle() === task.listName);
//       const listIndex = projects[indexOfOld].getProjectList().findIndex(i => i === task);

//       projects[indexOfOld].deleteTask(listIndex);
...
//   renderTask(new Task("Gay", "gayer", "10/11/23", "High", "All"))
// }
